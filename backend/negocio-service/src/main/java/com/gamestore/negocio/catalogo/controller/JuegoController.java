package com.gamestore.negocio.catalogo.controller;
...
import com.gamestore.negocio.catalogo.dto.JuegoDtoMapper;
import com.gamestore.negocio.catalogo.dto.JuegoDto;
 ...
 *
 * Los cuerpos de alta/edicion se enlazan con {@link JuegoFormRequestDto} y se
...
public class JuegoController {
    ...
    public JuegoDto crear(@Valid @ModelAttribute JuegoFormRequestDto form,
    ...
    public JuegoDto actualizar(@PathVariable Long id,
                               @Valid @ModelAttribute JuegoFormRequestDto form,
                               @RequestParam(required = false) MultipartFile imagen,
                               @AuthenticationPrincipal AuthPrincipal principal) {
