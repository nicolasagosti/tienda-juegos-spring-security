...
import com.gamestore.negocio.usuarios.web.dto.ActualizarUsuarioRequest;
...
public class UsuarioController {
    ...
    @PostMapping
    public UsuarioDto crear(@Valid @RequestBody CrearUsuarioRequest req) {
        return UsuarioDto.from(usuarioService.crearUsuario(
                req.username(), req.password(), req.nombreCompleto(), req.email(), req.rol()));
    }

    @PutMapping("/{id}")
    public UsuarioDto actualizar(@PathVariable Long id, @Valid @RequestBody ActualizarUsuarioRequest req) {
