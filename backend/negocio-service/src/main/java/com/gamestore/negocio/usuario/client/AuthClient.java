package com.gamestore.negocio.usuario.client;
 ...
 * perfil se guarda local (en esta misma app) y la credencial se delega aca.
 *
 ...
 * {@code UsuarioService} compense borrando el perfil), no que quede un
